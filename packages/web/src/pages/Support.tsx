    ...
    <div className="pt-16">
      <section className="py-28 px-6 bg-gradient-to-b from-[#111] to-[#0a0a0a]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-5xl md:text-6xl font-bold text-white mb-4">Donate Today</h1>
...
function Membership() {
  return (
    <div className="pt-16">
      <section className="py-28 px-6 bg-gradient-to-b from-[#111] to-[#0a0a0a] text-center">
        <p className="text-[#c9a84c] text-xs tracking-[0.4em] uppercase mb-4">Join Us</p>
        <h1 className="font-display text-5xl md:text-6xl font-bold text-white mb-4">Become A Member</h1>
        <p className="text-white/60 text-lg max-w-2xl mx-auto">Support Varscona with a recurring membership and enjoy exclusive benefits all season long.</p>
      </section>
      <section className="py-20 px-6">
  ...
  return (
    <div className="pt-16">
      <section className="relative py-28 px-6 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#8b1a1a] via-[#5a0f0f] to-[#0a0a0a]" />
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_right,_#c9a84c_0%,_transparent_60%)]" />
        <div className="relative max-w-4xl mx-auto text-center">
          <p className="text-[#c9a84c] text-xs tracking-[0.4em] uppercase mb-4">Capital Campaign</p>
          <h1 className="font-display text-5xl md:text-6xl font-bold text-white mb-4">Cue the Future</h1>
