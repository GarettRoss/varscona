  ...
  return (
    <footer className="bg-[#E5E1D8] px-4 md:px-8 pb-8 mt-auto">
      <div className="relative overflow-hidden rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.18)] bg-[#3a0a0a]">
              ...
              {[
                ...
                <li key={c.href}>
                  <a href={c.href} target="_blank" rel="noopener noreferrer"
                    className="text-[#F2EDDF]/50 hover:text-[#F2EDDF] text-sm transition-colors flex items-center gap-1">
                    {c.label}
        ...
        <div className="mt-12 pt-6 border-t border-[#F2EDDF]/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-[#F2EDDF]/30 text-xs">Copyright 2016 Varscona Theatre Alliance</p>
