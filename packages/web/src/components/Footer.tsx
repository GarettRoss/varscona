    ...
    <footer className="bg-black border-t border-white/10 mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <p className="font-display text-lg text-white tracking-wide mb-1">VARSCONA THEATRE</p>
            <p className="text-white/50 text-sm">10329 – 83 Avenue, Edmonton, Alberta</p>
            <p className="text-white/50 text-sm mt-1">(780) 433-3399</p>
            <div className="flex gap-4 mt-4">
              ...
              <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter / X"
                className="text-white/40 hover:text-[#c9a84c] transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.713 5.89zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: 'Die-Nasty', href: 'https://www.die-nasty.com' },
              ].map((c) => (
                <li key={c.href}>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/30 text-xs">Copyright 2016 Varscona Theatre Alliance</p>
